...
import utils.GUI_final.RunAnimation;
import utils.GUI.ActionInput;
import utils.GUI_final.MainWindow;

public class Final_Main
{
//	public static String inputFile = "data/Winnie-the-Pooh/Winnie-the-Pooh.obj";
//	public static Coord position = new Coord(0f, 0f, -70f, 1f); // for winnie
	
	public static String inputFile = "pot4.asc";
	public static Coord position = new Coord(0f, 0f, -30f, 1f); // for pot4.asc
